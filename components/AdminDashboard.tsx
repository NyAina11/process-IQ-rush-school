...
import { Database, Plus, Trash2, CheckCircle2, AlertCircle, ExternalLink, Settings2, ShieldCheck, LogOut, Loader2, Save, Users } from 'lucide-react';
            ...
            <aside className="w-72 bg-[#0f172a] text-white p-8 flex flex-col shadow-2xl">
                ...
                <nav className="flex-1 space-y-2">
                    <button 
                        ...
                        className={`w-full flex items-center gap-3 p-4 rounded-xl border transition-all ${activeTab === 'api' ? 'bg-white/10 border-white/20 text-white shadow-lg' : 'border-transparent text-slate-400 hover:bg-white/5 hover:text-white'}`}
                    >
                        <Database size={18} className={activeTab === 'api' ? 'text-blue-400' : ''} />
                        <span className="text-sm font-bold">API Integrations</span>
                    </button>
                    <button 
                        onClick={() => setActiveTab('users')}
                        className={`w-full flex items-center gap-3 p-4 rounded-xl border transition-all ${activeTab === 'users' ? 'bg-white/10 border-white/20 text-white shadow-lg' : 'border-transparent text-slate-400 hover:bg-white/5 hover:text-white'}`}
                    >
                        <Users size={18} className={activeTab === 'users' ? 'text-indigo-400' : ''} />
                        <span className="text-sm font-bold">Utilisateurs</span>
                    </button>
